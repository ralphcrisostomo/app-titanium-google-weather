...
// in simulator we redefine to format for myWeather Developer console
...
{\
	NSString * exceptionName = [@"org.myweather." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.myweather";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UImyWeatherNativeItemNone = -1, 
	UImyWeatherNativeItemSpinner = -2,
	UImyWeatherNativeItemProgressBar = -3,
	
	UImyWeatherNativeItemSlider = -4,
	UImyWeatherNativeItemSwitch = -5,
	UImyWeatherNativeItemMultiButton = -6,
	UImyWeatherNativeItemSegmented = -7,
	
	UImyWeatherNativeItemTextView = -8,
	UImyWeatherNativeItemTextField = -9,
	UImyWeatherNativeItemSearchBar = -10,
	
	UImyWeatherNativeItemPicker = -11,
	UImyWeatherNativeItemDatePicker = -12,
	
	UImyWeatherNativeItemInfoLight = -13,
	UImyWeatherNativeItemInfoDark = -14,
	
	UImyWeatherNativeItemDisclosure = -15,
	
	UImyWeatherNativeItemContactAdd = -16
};
