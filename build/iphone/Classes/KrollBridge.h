...
@interface myWeatherObject : KrollCoverageObject {
#else
@interface myWeatherObject : KrollObject {
#endif
@private
...
extern NSString * myWeather$ModuleRequireFormat;
