 ...
 * Copyright (c) 2009-2011 by myWeather, Inc. All Rights Reserved.
...
//@interface myWeatherObject : NSObject
//@end

@interface myWeatherObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[myWeatherObject class]])
		{
			for (NSString *key in [[(myWeatherObject*)o modules] allKeys])
			{
